...
final class Dictionary extends DictionaryBase {
     ...
     */
    private void checkSize(final int newSize) {
    ...
    /**
     * Create a new node at end of the array. On the current idx position is writing the pointer. The pointer on the current idx position must be 0 without some
     * word end flags (0x8000 on idx+1)
     *
    ...
    /**
     * Trims the capacity of this <tt>Dictionary</tt> instance to be the current size. An application can use this operation to minimize the storage of an
