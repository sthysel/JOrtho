...
class DictionaryEditDialog extends JDialog {
    ...
    /**
     * A hack for the layout manger to prevent that the dialog is to small to show the title line. The problem occur only if there are small words in the list.
     * With a empty list there are no problems.
     */
    @Override
