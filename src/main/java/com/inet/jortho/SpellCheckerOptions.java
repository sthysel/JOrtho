...
/**
 * This class contains some options for spell checking. You can change it globally(see ({@link SpellChecker#getOptions()}) or for every JTextComponent
...
public class SpellCheckerOptions {
    ...
    /**
     * Get the maximum count of entries for the suggestion list in the spell checker dialog.
     *
    ...
    /**
     * Set whether the spell checker is case-sensitive. This only has an effect on the first letter of a word. The default value is true.
     *
    ...
    /**
     * Set if words that are entirely in uppercase should be ignored for spell checking. This is most often used for abbreviations such DNS or HTTP. The default
     * value is true.
     *
    ...
    /**
     * Set whether capitalized words should be correct if the word is in the dictionary as lower-case. This is often used in a title or in names. The first word
     * of a sentence will always ignore the capitalization. The default is false.
     *
     * @param ignore the new value
     */
