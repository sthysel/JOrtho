...
/**
 * A hash list of Suggestions. The list is cut with a max dissimilarity. If a suggestion already exist then the suggestion with the lower dissimilarity will be
 * hold.
 *
